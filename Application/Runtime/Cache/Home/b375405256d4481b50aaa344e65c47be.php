                    ...
                    <ul class="nav" id="side-menu">
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Customer/add');?>">添加客户</a>
                                </li>
                                <li>
                                    <a class="active" href="<?php echo U('Customer/index');?>">客户列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('edit', [id => $row['id']]);?>" class="btn btn-primary">修改</a>
                                        <a href="<?php echo U('delete', [id => $row['id']]);?>" class="btn btn-danger">删除</a>
                                    </td>
